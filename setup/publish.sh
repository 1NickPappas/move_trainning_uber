...
MOVE_PACKAGE_PATH=../move/crypto_port
...
RIDES_STORAGE_ADDRESS=$(echo "$newObjs" | jq -r 'select (.objectType | contains("::ride::RidesStorage")) | .objectId')
...
RIDES_STORAGE_ADDRESS=$RIDES_STORAGE_ADDRESS
API_ENV
