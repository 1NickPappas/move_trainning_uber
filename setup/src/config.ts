...
export const RIDES_STORAGE_ADDRESS = process.env.RIDES_STORAGE_ADDRESS!;
...
console.log("env contains RIDES_STORAGE_ADDRESS:", keys.includes("RIDES_STORAGE_ADDRESS"));
